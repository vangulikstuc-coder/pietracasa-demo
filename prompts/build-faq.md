# Bouw Faq-pagina -- Stucq

## 1. TAAK
Bouw de Faq-pagina voor Stucq (Stucadoor, Haarlem). Platform: Maatwerk (custom code).

## 2. LEES EERST (in volgorde)
1. @CLAUDE.md -- build-contract
2. @pages/faq.md -- blueprint + uitvoerbare AC
...
## 3. BOUW-INSTRUCTIES
- Secties: Pagina-hero -> FAQ (gegroepeerd) -> Nog een vraag?
...
grep -r 'TODO|PLACEHOLDER' src/pages/faq* -- mag niets teruggeven
