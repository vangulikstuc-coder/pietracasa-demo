# Bouw Over stucq-pagina -- Stucq

## 1. TAAK
Bouw de Over stucq-pagina voor Stucq (Stucadoor, Haarlem). Platform: Maatwerk (custom code).

## 2. LEES EERST (in volgorde)
1. @CLAUDE.md -- build-contract
2. @pages/over-stucq.md -- blueprint + uitvoerbare AC
...
## 3. BOUW-INSTRUCTIES
- Secties: Pagina-hero: Wie is Stucq -> Kerncijfers-band -> Achtergrond en werkwijze -> Werkgebied -> Google-reviews bewijs -> Keurmerken en waarborg -> Voor-na projectfoto's teaser -> Contactgegevens en openingstijden -> CTA-band
...
grep -r 'TODO|PLACEHOLDER' src/pages/over-stucq* -- mag niets teruggeven
