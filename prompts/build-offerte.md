# Bouw Offerte-pagina -- Stucq

## 1. TAAK
Bouw de Offerte-pagina voor Stucq (Stucadoor, Haarlem). Platform: Maatwerk (custom code).

## 2. LEES EERST (in volgorde)
1. @CLAUDE.md -- build-contract
2. @pages/offerte.md -- blueprint + uitvoerbare AC
...
## 3. BOUW-INSTRUCTIES
- Secties: Pagina-header met micro-garantie -> Bewijs-strip boven formulier -> Formulier met contextuele garantie -> Of bel direct -> Waarvoor vraagt u een offerte aan -> Zo verloopt het traject -> Bewijs: afgeronde projecten in Haarlem -> Google-reviews -> Afsluitende CTA-band
...
grep -r 'TODO|PLACEHOLDER' src/pages/offerte* -- mag niets teruggeven
