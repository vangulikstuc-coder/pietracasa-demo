# Bouw Microcement-pagina -- Stucq

## 1. TAAK
Bouw de Microcement-pagina voor Stucq (Stucadoor, Haarlem). Platform: Maatwerk (custom code).

## 2. LEES EERST (in volgorde)
1. @CLAUDE.md -- build-contract
2. @pages/microcement.md -- blueprint + uitvoerbare AC
...
grep -r 'TODO|PLACEHOLDER' src/pages/microcement* -- mag niets teruggeven
