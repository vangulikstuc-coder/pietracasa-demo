# Bouw Werkwijze-pagina -- Stucq

## 1. TAAK
Bouw de Werkwijze-pagina voor Stucq (Stucadoor, Haarlem). Platform: Maatwerk (custom code).

## 2. LEES EERST (in volgorde)
1. @CLAUDE.md -- build-contract
2. @pages/werkwijze.md -- blueprint + uitvoerbare AC
...
grep -r 'TODO|PLACEHOLDER' src/pages/werkwijze* -- mag niets teruggeven
