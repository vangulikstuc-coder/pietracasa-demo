# Bouw Contact-pagina -- Stucq

## 1. TAAK
Bouw de Contact-pagina voor Stucq (Stucadoor, Haarlem). Platform: Maatwerk (custom code).

## 2. LEES EERST (in volgorde)
1. @CLAUDE.md -- build-contract
2. @pages/contact.md -- blueprint + uitvoerbare AC
...
## 3. BOUW-INSTRUCTIES
- Secties: Paginaheader – Direct contact -> Contactmiddelen – Twee paden -> Contactformulier – Alternatief pad -> Werkgebied – Regio overzicht -> Openingstijden & beschikbaarheid -> Vertrouwensband – Bewijs voor het laatste moment -> Secundaire CTA – Offerte of projecten
...
grep -r 'TODO|PLACEHOLDER' src/pages/contact* -- mag niets teruggeven
